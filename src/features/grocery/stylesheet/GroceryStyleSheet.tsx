...
const styles=StyleSheet.create({
    ...
    searchInput:{backgroundColor:Colors.backgroundColor, borderWidth:1, height:38, width:280, borderRadius:10, paddingLeft:40,},
    cameraLogo:{position:'absolute', right:52, alignSelf:'center'},
    ...
    bodyContainer:{marginTop:28, marginLeft:17,overflow:'hidden'},
    bodyImage:{ height:67 , width:77, aspectRatio:1,flex: 1, borderRadius: 8, backgroundColor: Colors.imagebackgroundColor, overflow: 'visible', elevation: 5, shadowColor: '#000', shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.2, shadowRadius: 4,},
