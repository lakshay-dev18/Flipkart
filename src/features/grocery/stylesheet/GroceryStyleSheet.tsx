...
const styles=StyleSheet.create({
    ...
    bodyImage:{ height:67 , width:77, aspectRatio:1,flex: 1, borderRadius: 8, backgroundColor: Colors.imagebackgroundColor, overflow: 'visible', elevation: 5, shadowColor: '#000', shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.2, shadowRadius: 4,resizeMode:'contain', },
